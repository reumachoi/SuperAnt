...
// depth 1 = ' '->
// depth 2 = '  '->
    public String insertReplyArrow(int depth){
        String res = "<img src='../../img/reply_arrow.png' width='20px' height='20px' />";
        String nbsp = "&nbsp;&nbsp;&nbsp;&nbsp;";	// 여백
        String ts = "";
...
<div class="body__container">
        ...
        <article>
            <div id="app">
                ...
                <div class="board">
                    <h2>투자 정보</h2>
                    <%
                        List<StockBoardDto> list = (List<StockBoardDto>) request.getAttribute("stockBoardList");
                    %>
                    <%
                        List<StockBoardParam> li = (List<StockBoardParam>) request.getAttribute("stockBoardSearch");
                    %>
                    <div class="search-nav-bar">
                        <form action="getBoardSearch.do" method="get" class="search-form">
                    ...
                    <table class="table">
                        ...
                        <%
                            ...
                            for (int i = 0; i < list.size(); i++) {
                                StockBoardDto dto = list.get(i);
                        %>
                        <tr>
                            <th><%= i+1%></th>
                            <td>
                                <%= insertReplyArrow(dto.getBORDEPTH())%>
                                <a
                                        class="go-to-detail"
                                        href="inveInformDetail.do?BORINDEX=<%=dto.getBORINDEX()%>"
                                >
                                    <%=dto.getBORTITLE()%>
                                </a>
                            </td>
                            <td><%=dto.getBORUSERID()%></td>
    ...
    <footer>
        <div class="footer-section">
            <ul class="footer-menu float-start">
                ...
                <li><a href="stock-inform.do">투자정보</a></li>
                <li><a href="stock-discuss.do">종목토론방</a></li>
                <li><a href="stock-notice.do">전자공시정보</a></li>
            </ul>
    ...
    <script>
        ...
        const goToNewPost = () => location.href = 'goStBorToNewPost.do';
    </script>
