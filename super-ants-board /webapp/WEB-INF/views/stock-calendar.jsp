...
<div class="body__container">
    ...
    <section>
        ...
        <article>
            <div id="app">
                <div class="cal-msg-box">
                    <div class="cal-msg-box-contents">
                        <h3 class="cal-title">
                            <img src="https://img.icons8.com/emoji/36/000000/warning-emoji.png"/>
                            공모주 일정 : 주의사항 및 당부말씀
                            <img src="https://img.icons8.com/emoji/36/000000/warning-emoji.png"/>
                        </h3>
                        <p class="cal-msg-para">
                            날짜 착오 및 잘못된 투자로 인한 피해에 대해 책임지지 않습니다. <br>
                            과도한 투자는 가계 경제에 위협이 되며 신용평점에 악영향을 끼칠 수 있습니다.
                        </p>
                    </div>
                </div>
                <div class="calendar-box">
                    <iframe src="https://securities.miraeasset.com/hku/hku4042/r01.do"></iframe>
                </div>
            </div>
        </article>
    </section>
