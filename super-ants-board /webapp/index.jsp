...
<%--                                로그인상태--%>
    ...
    <section>
        ...
        <article>
            <div id="app">
                <div id="item-box">
                    <h2 class="app__title">어서오세요, 사용하실 메뉴를 선택해주세요.</h2>
                    <div id="item-box-inner">
                        <img src="./img/main-page-img-4.jpeg" onclick="goToStockCal()" />
                        <img src="./img/main-page-img-1.jpeg" onclick="goToInveInform()" />
                        <img src="./img/main-page-img-2.jpeg" onclick="goToDigiNotice()" />
                        <img src="./img/main-page-img-3.jpeg" onclick="goToDiscuss()" />
                    </div>
                </div>
            </div>
        </article>
    ...
    <script>
        ...
        // 이미지 배너에서 각 메뉴로 보내줄 함수
        const goToStockCal = () => location.href = 'stock-calendar.do';
        const goToInveInform = () => location.href = 'inve-inform.do';
        const goToDiscuss = () => location.href = 'stock-discuss.do';
        const goToDigiNotice = () => location.href = 'stock-notice.do';
    </script>
</div>
</body>
</html>
